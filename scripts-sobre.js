...
window.addEventListener('DOMContentLoaded', function() {
  setTimeout(function() {
    if (!localStorage.getItem('cookiesAccepted')) {
      ...
      banner.innerHTML = 'Este site utiliza cookies para melhorar sua experiência. Ao continuar navegando, você concorda com nossa <a href="politica-de-privacidade.html" style="color:#ffd700;text-decoration:underline;">Política de Privacidade</a>.' +
